...
public class PayrollPaymentFactoryImpl implements PayrollPaymentFactory{
    @Override
    public PayrollPayment create(IPayroll payroll, LocalDate paymentDate, PaymentMethod method, PaymentStatus status) throws PayrollPaymentException {
        return new PayrollPayment.Builder()
                .payroll(payroll)
